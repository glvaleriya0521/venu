	...
	<div class="row">
	    ...
	    <div class="card-action title">
	      <div class="row" style="margin-bottom:0;">
	      	<div class="col s9">
		      	<img src="{{asset('images/icons/artists--popup-profile-message-icon@2x.png')}}" alt="" style="width: 25px;display:none; top: 7px; position:relative; margin-right: 4px;"/>
				 ...
				 success: function(data){
					...
					if (data == "false") {
						...
						for (var index in messages){
							...
							var conversation_str = '<li class="collection-item avatar row" style="padding:0 !important; border-radius: 10px !important; background-color: #000 !important; color: #000 !important;">'
