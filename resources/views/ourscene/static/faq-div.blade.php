<div class="card" id="faq-card">
	<div class="card-content">
		<div class="row">
			<span class="center-align faq-title"> Frequently Asked Questions </span>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<p class="col s12 m12 l12">
				Signing up is easy! Simply follow this link
				( <a href="{{url('venue-register')}}">venue</a> | <a href="{{url('artist-register')}}">artist</a> )
				to get started.
			</p>
		</div>
		<div class="row">
			...
			<p class="col s12 m12 l12">
				No problem! Click <a href="{{url('login')}}?reset-password=true">here</a> to change it.
			</p>
		</div>
		<div class="row">
			<span class="col s12 m12 l12 section-title">
		...
		<div class="row">
			...
			<p class="col s12 m12 l12">
				Simple! Click <a href="{{url('legal/terms-of-service')}}">here</a> to read them.
			</p>
		</div>
		<div class="row">
			<span class="col s12 m12 l12 section-title">
			...
			<p class="col s12 m12 l12">
				Easy! Click <a href="{{url('legal/privacy-policy')}}">here</a> for that.
			</p>
		</div>
	</div>
</div>