...
Hooray! {{ $artist->name }} accepted your request for service.
...
You can <a href="{{ action('UserController@getLogin') }}" style="color: #534d93; text-decoration: none;">log in</a> to view the current artist lineup for this event.
