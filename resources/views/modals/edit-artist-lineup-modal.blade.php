<div id="edit-artist-lineup-modal" class="modal">
	<div class="modal-content">

		<div class="ourscene-modal-title-1">Edit artist lineup</div>

		<br/>
		
		{!! Form::open(array(
			'id'			=> 'edit-artist-lineup-form',
		)) !!}
	...
	<div class="modal-footer">
		...
		<a class="modal-action btn" style="margin-right: 10px;" onClick="$('<input type=\'submit\'>').hide().appendTo('#edit-artist-lineup-form').click().remove();">Update</a>
	</div>
</div>